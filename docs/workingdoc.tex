...
Based on the Elbow method, we determined that four clusters (Figure III) best represent the Goodreads user base: "Generous Consumer," "Harsh Consumer," "Powered Reader," and "Standard Reviewer."

\subsubsection{Cluster 0: Generous Consumer}

This the biggest reading group. Although the readers in this group rate the least number of books, they seem to love the books they do rate as they have an average rating of 4.44 with a small rating variance of 0.56.

\subsubsection{Cluster 1: Harsh Consumer }
This group is the third largest reading group. This reading group is categorized by the lowest overall rating of any group group. With an average rating of 2.94 and a high variance, it suggests that they either find a rare "5-star" gem or more likely loathe what they read. These are your more difficult to please critics.
...
Reviewing our data allows identified several distinct themes that drive community interaction. While our team identified 40 topics a few of the big themes were Analytical critique, Emotional Reactionaires and Administrative / ARC disclaimers.
...
\begin{itemize}
    ...
    \item \textbf{Administrative / ARC disclaimers (Topic 30):} Topic 30 was an interesting one. Despite our team doing our best to pre-process our datasets and remove administrative tags a few reviews were prevalent enough to be included. Topic 30 mainly noted that the readers talked abotu their blog or disclosing advanced reader's copies before reviewing. Most authors hand out Advanced Reader's Copies (ARC) for them to get a bunch of reviews before a product launch. Since the expectation for readers with ARCs is to review books our team expects to have high levels of engagement. Furthermore, this group had a \texttt{n\_votes} value of 1.90 while \texttt{n\_comments} had a value of 0.54.
